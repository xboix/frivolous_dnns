...
num_train_ex = int(sys.argv[1])
data_trial = int(sys.argv[2])
PATH_TO_INPUT_DATA = '/om2/user/xboix/data/ImageNet/'
PATH_TO_OUTPUT_DATA = '/om/user/xboix/ImageNet_500/'

if not os.path.exists(PATH_TO_OUTPUT_DATA):
    os.makedirs(PATH_TO_OUTPUT_DATA)

tf.app.flags.DEFINE_string('train_directory', PATH_TO_INPUT_DATA + 'raw-data/train',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', PATH_TO_INPUT_DATA + 'raw-data/validation',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', PATH_TO_OUTPUT_DATA,
...
tf.app.flags.DEFINE_string('labels_file',
                           PATH_TO_INPUT_DATA + 'imagenet_lsvrc_2015_synsets.txt',
                           'Labels file')
...
tf.app.flags.DEFINE_string('imagenet_metadata_file',
                           PATH_TO_INPUT_DATA + 'imagenet_metadata.txt',
...
tf.app.flags.DEFINE_string('bounding_box_file',
                           PATH_TO_INPUT_DATA + 'raw-data/imagenet_2012_bounding_boxes.csv',
                           'Bounding box file')
...
def _process_dataset(name, directory, num_shards, num_train_ex,
...
def main(unused_argv):
    ...
    _process_dataset('train', FLAGS.train_directory, FLAGS.train_shards,
                     num_train_ex, synset_to_human, image_to_bboxes)
    _process_dataset('validation', FLAGS.validation_directory,
                     FLAGS.validation_shards, num_train_ex, synset_to_human, image_to_bboxes)
