...
# *SC*
def parse_record(example_proto, is_training, dtype, augment):
    if is_training:
        set_name_app = 'train'
    else:
        set_name_app = 'test'
    ...
    float_image = preprocess_image(image, is_training, augment)
...
'''
def parse_record(raw_record, is_training, dtype, augment, rand_labels):  # *SC*
    ...
    image = preprocess_image(image, is_training, augment)  # *SC*
...
def preprocess_image(image, is_training, augment):  # *SC*
