...
class Rand100(dataset.Dataset):

    def __init__(self, opt):
        super(Rand100, self).__init__(opt)

        self.num_threads = 8

        self.list_labels = range(2)
        self.num_images_training = 100
    ...
    def get_data_trainval(self):
        ...
        train = self.__unpickle('train_100.pickle')
        val = self.__unpickle('val_100.pickle')
    ...
    def get_data_test(self):
        test = self.__unpickle('test_100.pickle')
