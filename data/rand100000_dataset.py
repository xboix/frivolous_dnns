...
class Rand100000(dataset.Dataset):

    def __init__(self, opt):
        super(Rand100000, self).__init__(opt)
    ...
    def get_data_trainval(self):
        ...
        train = self.__unpickle('train_100000.pickle')
        val = self.__unpickle('val_100000.pickle')
    ...
    def get_data_test(self):
        test = self.__unpickle('test_100000.pickle')
