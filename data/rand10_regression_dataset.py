...
class Rand10_regression(dataset.Dataset):

    def __init__(self, opt):
        super(Rand10_regression, self).__init__(opt, opt.hyper.mse)
    ...
    def get_data_trainval(self):
        ...
        train = self.__unpickle('/om/user/scasper/data/synthetic_regression/train_10.pickle')
        val = self.__unpickle('/om/user/scasper/data/synthetic_regression/val_10.pickle')
    ...
    def get_data_test(self):
        test = self.__unpickle('/om/user/scasper/data/synthetic_regression/test_10.pickle')
