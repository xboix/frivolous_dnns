...
def main():
    ...
    plot(data, plot_single_data,
         plotting_columns=['perturbation_layer', 'training_dropout', 'random_labels','training_weight_decay', 'training_data_augmentation', 'random_labels', 'condition', 'perturbation_amount', 'performance', 'cross_validation'] + \
                          [column for column in data.columns if column.startswith('multiplier_layer')],
         results_subdirectory='multiplier_robustness_layer')
