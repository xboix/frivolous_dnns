...
class Model(object):
    ...
    def __call__(self, inputs, training):
        ...
        with self._model_variable_scope():
            ...
            for i, num_blocks in enumerate(self.block_sizes):  # by default, block_sizes is [9, 9, 9]
            ...
            # building/bottleneck block, eg resnet_old V2.
...
class Cifar10Model(Model):
    ...
    def __init__(self, resnet_size, size_factor, data_format=None, num_classes=NUM_CLASSES,
        ...
        super(Cifar10Model, self).__init__(
            ...
            num_filters=int(16*size_factor),  # *SC*
            kernel_size=3,
            conv_stride=1,
...
def ResNet(im, opt):
    model = Cifar10Model(resnet_size=RESNET_SIZE, size_factor=opt.dnn.neuron_multiplier[0])
    logits, activations = model(im, training=False)
...
class Model_test(object):
    ...
    def __call__(self, inputs, opt, select, perturbation_params, perturbation_type, training):
        """Add operations to classify a batch of input images.
...
class Cifar10Model_test(Model_test):
    ...
    def __init__(self, resnet_size, size_factor, data_format=None, num_classes=NUM_CLASSES,
        ...
        super(Cifar10Model_test, self).__init__(
            resnet_size=resnet_size,
            bottleneck=False,
            num_classes=num_classes,
            num_filters=int(16*size_factor),  # *SC*
...
def ResNet_test(im, opt, select, perturbation_params, perturbation_type):
